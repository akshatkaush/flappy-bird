...
void introScreen()
{
	...
	glColor3f(0, 0, 1);
	renderBitmapString(-150, 265, GLUT_BITMAP_TIMES_ROMAN_24, "Thapar Institute, Patiala");
	glColor3f(0.7, 0, 1);
	renderBitmapString(-160, 230, GLUT_BITMAP_TIMES_ROMAN_24, "DEPARTMENT OF COMPUTER ENGINEERING");
	glColor3f(1, 0.5, 0);
	renderBitmapString(-90, 120, GLUT_BITMAP_TIMES_ROMAN_24, "Computer Graphics Project");
	glColor3f(1, 0, 0);
	renderBitmapString(-120, 90, GLUT_BITMAP_TIMES_ROMAN_24, "FLAPPY BIRD using OpenGL");
	glColor3f(1, 0.5, 0);
	renderBitmapString(-290, -30, GLUT_BITMAP_TIMES_ROMAN_24, "BY:");
	glColor3f(0.5, 0, 0.5);
	renderBitmapString(-260, -60, GLUT_BITMAP_TIMES_ROMAN_24, "Naman Monga");
	renderBitmapString(-260, -90, GLUT_BITMAP_TIMES_ROMAN_24, "Akshat Kaushal");
	renderBitmapString(-260, -120, GLUT_BITMAP_TIMES_ROMAN_24, "Yash Bhatnagar");
	glColor3f(1, 0.5, 0);
	renderBitmapString(40, -30, GLUT_BITMAP_TIMES_ROMAN_24, "Guided by:");
	glColor3f(0.5, 0.2, 0.2);
	renderBitmapString(120, -60, GLUT_BITMAP_TIMES_ROMAN_24, "Archana Kumari");
	glColor3f(1, 0.1, 1);
